...
import com.qticket.gateway.dto.AuthResponseDto;
...
public class JwtFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (requestPath.equals("/users/signUp") || requestPath.equals("/users/login") || requestPath.equals("/users/resetPassword")) {
